...
-- AddForeignKey
ALTER TABLE "permissions" ADD CONSTRAINT "permissions_fk1" FOREIGN KEY ("intern_person_id") REFERENCES "intern"("person_id") ON DELETE NO ACTION ON UPDATE NO ACTION;
