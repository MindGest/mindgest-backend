...
async function seed() {
  ...
  // intern for register approval
  let personForApproval = await prisma.person.create({
    data: {
      active: true,
      verified: true,
      approved: false,
      name: "Orácio",
      email: "oracio@student.dei.uc.pt",
      password: await argon2.hash("12345"),
      address: "Rua da Perdição",
      birth_date: new Date("2000-11-21T23:50:28.538Z"),
      phone_number: 912345678,
      tax_number: 231321123,
    },
  })
  let internForApproval = await prisma.intern.create({
    data: {
      person_id: personForApproval.id,
    },
  })
  ...
  await prisma.patient_process.create({
    data: { patient_person_id: patientChild1.person_id, process_id: processChild1.id },
  })
  // add main therapist
  // create link
  await prisma.therapist_process.create({
    data: { therapist_person_id: therapist1.person_id, process_id: processChild1.id },
  })
  // create permissions
  ...
  await prisma.intern_process.create({
    data: { intern_person_id: intern1.person_id, process_id: processChild1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // create link
  await prisma.therapist_process.create({
    data: { therapist_person_id: therapist2.person_id, process_id: processChild1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  await prisma.process_liable.create({
    data: { liable_id: liableFather.id, process_id: processChild1.id },
  })
  // 2
  await prisma.process_liable.create({
    data: { liable_id: liableMother.id, process_id: processChild1.id },
  })
  // 3
  await prisma.process_liable.create({
    data: { liable_id: liableOther.id, process_id: processChild1.id },
  })
  // add appointments
  ...
  // add patient (create link)
  await prisma.patient_process.create({
    data: { patient_person_id: patientTeen1.person_id, process_id: processTeen1.id },
  })
  // add main therapist
  // create link
  await prisma.therapist_process.create({
    data: { therapist_person_id: therapist2.person_id, process_id: processTeen1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // create link
  await prisma.intern_process.create({
    data: { intern_person_id: intern2.person_id, process_id: processTeen1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // create link
  await prisma.therapist_process.create({
    data: { therapist_person_id: therapist3.person_id, process_id: processTeen1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // 1
  await prisma.process_liable.create({
    data: { liable_id: liableFather.id, process_id: processTeen1.id },
  })
  // 2
  await prisma.process_liable.create({
    data: { liable_id: liableMother.id, process_id: processTeen1.id },
  })
  // add appointments
  ...
  // add patient (create link)
  await prisma.patient_process.create({
    data: { patient_person_id: patientAdult1.person_id, process_id: processAdult1.id },
  })
  // add main therapist
  // create link
  await prisma.therapist_process.create({
    data: { therapist_person_id: therapist3.person_id, process_id: processAdult1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // create link
  await prisma.intern_process.create({
    data: { intern_person_id: intern1.person_id, process_id: processAdult1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // create link
  await prisma.therapist_process.create({
    data: { therapist_person_id: therapist1.person_id, process_id: processAdult1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // 1
  await prisma.process_liable.create({
    data: { liable_id: liableOther.id, process_id: processAdult1.id },
  })
  // 2
  await prisma.process_liable.create({
    data: { liable_id: liableFather.id, process_id: processAdult1.id },
  })
  // add appointments
  ...
  // add patient (create link)
  await prisma.patient_process.create({
    data: { patient_person_id: patientElder1.person_id, process_id: processElder1.id },
  })
  // add main therapist
  // create link
  await prisma.therapist_process.create({
    data: { therapist_person_id: therapist1.person_id, process_id: processElder1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // create link
  await prisma.intern_process.create({
    data: { intern_person_id: intern2.person_id, process_id: processElder1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // create link
  await prisma.therapist_process.create({
    data: { therapist_person_id: therapist2.person_id, process_id: processElder1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // 1
  await prisma.process_liable.create({
    data: { liable_id: liableOther.id, process_id: processElder1.id },
  })
  // add appointments
  ...
  // father
  await prisma.patient_process.create({
    data: { patient_person_id: patientFamily1Father.person_id, process_id: processFamily1.id },
  })
  // mother
  await prisma.patient_process.create({
    data: { patient_person_id: patientFamily1Mother.person_id, process_id: processFamily1.id },
  })
  // child
  await prisma.patient_process.create({
    data: { patient_person_id: patientFamily1Child1.person_id, process_id: processFamily1.id },
  })
  // add main therapist
  // create link
  await prisma.therapist_process.create({
    data: { therapist_person_id: therapist2.person_id, process_id: processFamily1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // create link
  await prisma.intern_process.create({
    data: { intern_person_id: intern1.person_id, process_id: processFamily1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // create link
  await prisma.therapist_process.create({
    data: { therapist_person_id: therapist3.person_id, process_id: processFamily1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // boy
  await prisma.patient_process.create({
    data: { patient_person_id: patientCouple1Boy1.person_id, process_id: processCouple1.id },
  })
  // girl
  await prisma.patient_process.create({
    data: { patient_person_id: patientCouple1Girl1.person_id, process_id: processCouple1.id },
  })
  // add main therapist
  // create link
  await prisma.therapist_process.create({
    data: { therapist_person_id: therapist3.person_id, process_id: processCouple1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // create link
  await prisma.intern_process.create({
    data: { intern_person_id: intern2.person_id, process_id: processCouple1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
  ...
  // create link
  await prisma.therapist_process.create({
    data: { therapist_person_id: therapist1.person_id, process_id: processCouple1.id },
  })
  // create permissions
  await prisma.permissions.create({
    data: {
