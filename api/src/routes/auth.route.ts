...
auth.post(
    '/register',
    middleware.requestValidator(schemas.RegistrationSchema),
    controller.register
)

auth.post(
    '/login',
    middleware.requestValidator(schemas.LoginSchema),
    controller.login
)

auth.post(
    '/refresh',
    middleware.requestValidator(schemas.RefreshSchema),
    controller.refresh
)
