...
export async function editUser(req: Request, res: Response){
    ...
    var userType = await getUserType(req.body.id, prisma); // so we know what type of user we want to update
    ...
    if (userType == 'therapist'){
        updateInfoTherapist(req, res, prisma, 'therapist');
    }
    else if(userType == 'accountant'){
        updateInfoPerson(req, res, prisma, 'accountant');
    }
    else if(userType == 'patient'){
        updateInfoPatient(req, res, prisma, 'patient');
    }
    else if(userType == 'guard'){
        updateInfoPerson(req, res, prisma, 'guard');
    }
    else if(userType == 'intern'){
        updateInfoPerson(req, res, prisma, 'intern');
    }
...
async function getUserType(id: number, prisma: PrismaClient){
    /**
     * parameters:
...
async function updateInfoTherapist(req: Request, res: Response, prisma: PrismaClient, userType: String){
        ...
        data :{
            ...
            person: {
                update:{
                        ...
                        phone_number: ((body.phone_number == EMPTY_FIELD) ? oldData.person.phone_number : body.phone_number), 
                }
            }
        },
        where: {person_id: userId},
...
async function updateInfoIntern(req: Request, res: Response, prisma: PrismaClient, userType: String){
    var EMPTY_FIELD = 'null';
    var body = req.body; // it must have a parameter named "data" that has the json structure of a therapist.
    var userId = req.body.id;
...
async function updateInfoGuard(req: Request, res: Response, prisma: PrismaClient, userType: String){
    var EMPTY_FIELD = 'null';
    var body = req.body; // it must have a parameter named "data" that has the json structure of a therapist.
    var userId = req.body.id;
...
async function updateInfoAccountant(req: Request, res: Response, prisma: PrismaClient, userType: String){
    var EMPTY_FIELD = 'null';
    var body = req.body; // it must have a parameter named "data" that has the json structure of a therapist.
    var userId = req.body.id;
...
async function updateInfoPatient(req: Request, res: Response, prisma: PrismaClient, userType: String){
    var EMPTY_FIELD = 'null';
    var body = req.body; // it must have a parameter named "data" that has the json structure of a therapist.
    var userId = req.body.id;
...
async function updateInfoPerson(req: Request, res: Response, prisma: PrismaClient, userType: String){
    /**
