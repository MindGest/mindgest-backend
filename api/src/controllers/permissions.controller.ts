...
export async function getInternsPermissions(req: Request<{}, {}, GetPermissionsBody>, res: Response){
    /**
    ...
    try{
        ...
        if (callerRole == 'therapist'){
            let therapistInProcess = await prisma.therapist_process.findFirst({where: {therapist_person_id: callerId, process_id: processId}})
        ...
        let intern_permissions = await prisma.permissions.findMany({where: {process_id: processId}, select: {
            editprocess: true,
            see: true,
            appoint: true,
            statitics: true,
...
export async function editInternPermissions(req: Request<{}, {}, EditPermissionsBody>, res: Response){
    /**
    ...
    try{
        ...
        let intern_process = await prisma.intern_process.findFirst({where: {process_id: processId, intern_person_id: req.body.collaboratorId}});
        ...
        let permission = await prisma.permissions.findFirst({where: {
