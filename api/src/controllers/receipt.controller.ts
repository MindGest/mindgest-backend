    ...
    try {
        ...
        if (queryParams.userId==null){
            ...
            for(let receipt of listReceipts){
                ...
                listOfReceipts.push({"patientName": patient?.name, "mainTherapist": mainTherapistObject?.name, "ref": receipt.ref,"date":receipt.datetime})
            }
        }
        else{
            ...
            for(let appointment of appointments){
                ...
                if((payed == notPayed == true) || (payed == true && receipt?.payed) || (notPayed == true && !receipt?.payed)){
                    listOfReceipts.push({"patientName": patient?.name, "mainTherapist": mainTherapistObject?.name, "ref": receipt?.ref,"date":receipt?.datetime})
                }
            }
        }
