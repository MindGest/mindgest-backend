...
describe("2.0 test listing appointments", () => {
  it("2.0.0 List every appointment", async () => {
  ...
  it("2.0.1 User doesn't have authorization", async () => {
  ...
  it("2.0.2 The user's Verification Token is expired/invalid", async () => {
